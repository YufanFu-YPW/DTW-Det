...
@register
class DTWDetTransformer(nn.Module):
    ...
    def __init__(self,
        ...
        super(DTWDetTransformer, self).__init__()
    ...
    def forward(self, encoder_out, targets=None):
        ...
        encoder_out["FADE"]["min_num_select"] = self.min_num_select
        encoder_out["FADE"]["max_num_select"] = self.max_num_select
